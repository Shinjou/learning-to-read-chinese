...
/* The original WordState class is too complicated. We will keep three properties:
   - currentWord: the current word being displayed
   - isLearned: whether the current word is learned
    - isBpmf: whether the current word is in BPMF format
*/
